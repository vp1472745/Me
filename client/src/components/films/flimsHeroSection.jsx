...
import Image from "../../assets/herosectionImage/flimimageherosection.jpg";

const HeroSection = () => {
  return (
    <section className="relative w-full  h-[695px] flex items-center justify-center overflow-hidden">
      {/* Background Image */}
