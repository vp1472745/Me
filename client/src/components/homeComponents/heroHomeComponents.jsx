    ...
    <>
      ...
      {heroes.length === 0 ? (
        <HeroNotFound
          categoryName="Home"
          title="WELCOME"
          subtitle="Imagine waking up to a job that lifts you up and transports you to a different world. A world populated with a billion heartfelt feelings and stories."
          height="h-screen"
        />
      ) : (
